...
function Signup(props) {
    ...
    return (
        <div style={{ backgroundImage: "url('https://th.bing.com/th/id/OIP.QdEXYjcxXGpEYds_749dZwHaFP?pid=ImgDet&w=1322&h=936&rs=1')", backgroundSize: 'cover', backgroundRepeat: 'no-repeat', borderRadius: '20px', maxWidth: '70%', height: '500px' }} className="container my-3">
